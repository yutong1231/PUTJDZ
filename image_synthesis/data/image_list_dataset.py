...
class ImageListDataset(Dataset):
    ...
    def __init__(self, 
        ...
        root = os.path.join(data_root, self.name)#data/JDG/train
        print('ROOT:',root)
        ...
        print('an instance of paths:',paths[0])
    ...
    def set_provided_mask_ratio(self, mask_ratio=None):
        ...
        if self.provided_mask_name != '' and self.use_provided_mask > 0:
            ...
            if self.provided_mask_list_file == '':
                mask_dir = os.path.join(self.data_root, self.provided_mask_name)#self.data_root = data
            ...
            my_print('Number of masks: {}, start: {}, end: {}'.format(end-start, start+1, end))
            if len(self.masks) == 0:
                self.masks = None
